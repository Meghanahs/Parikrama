  ...
  <body class="login-body">
    ...
    <div class="container">
      ...
      <form class="form-signin" method="post" action="auth/login">
        <h2 class="login form-signin-heading"><?php echo $this->db->get('settings')->row()->login_title; ?><br/><br/><img alt="" width="100px" src="<?php echo $this->db->get('settings')->row()->login_logoo; ?>"></h2>
