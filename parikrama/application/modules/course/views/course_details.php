    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-list"></i>  <?php echo lang('course_name'); ?> : <?php
                $course_details = $this->course_model->getCourseById($course_id);
            ...
            <div class="panel-body col-md-8">
                <div class="adv-table editable-table ">
                    <div class="clearfix search_row">
                        <div class="panel">
                            <a class="btn btn-info btn-xs btn_width" href="course/courseMaterial?course=<?php echo $couse_details->id; ?>"><i class=""> </i> <?php echo lang('course'); ?> <?php echo lang('material'); ?></a>
                        </div>
