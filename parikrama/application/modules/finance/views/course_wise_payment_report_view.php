    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-user"></i>  <?php echo lang('course_wise_income_report'); ?>
            </header>
            ...
            <div class="panel-body">
                <form role="form" action="finance/courseWiseIncomeReport" method="post" enctype="multipart/form-data">
                    <div class="attendence_top">
                        ...
                        <div class="form-group">
                            <button type="submit" name="submit" value="submit" class="btn btn-info">  <?php echo lang('income'); ?> <?php echo lang('report'); ?></button>
                        </div>
