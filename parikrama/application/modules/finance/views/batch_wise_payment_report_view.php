    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-user"></i>  <?php echo lang('batch_wise_income_report'); ?>
            </header>
            ...
            <div class="panel-body">
                <form role="form" action="finance/batchWiseIncomeReport" method="post" enctype="multipart/form-data">
