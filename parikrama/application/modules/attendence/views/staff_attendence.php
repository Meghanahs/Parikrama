    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-user"></i>  <?php echo lang('staff'); ?> <?php echo lang('attendence'); ?> <?php echo lang('report'); ?>
            </header>


            <div class="panel-body">
                <form role="form" action="attendence/staffAttendenceDetails" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="submit" value="submit" class="btn btn-info">  <?php echo lang('attendence'); ?> <?php echo lang('report'); ?></button>
