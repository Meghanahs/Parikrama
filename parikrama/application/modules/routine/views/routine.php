    ...
    <section class="wrapper site-min-height">
        ...
        <section class="panel">
            <header class="panel-heading">
                <i class="fa fa-table"></i>  <?php echo lang('view'); ?> <?php echo lang('routine'); ?>
            </header>

            <div class="panel-body">
                <form role="form" action="routine/viewRoutine" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                     ...
                     <button type="submit" name="submit" class="btn btn-info"> <i class="fa fa-eye"></i> <?php  echo lang('view_routine'); ?></button>
