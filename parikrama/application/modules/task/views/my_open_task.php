                            ...
                            if ($task->requested_for == $current_user) {
                                ...
                                <tr class="">
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            <button type="button" href="#myModal5" class="btn btn-info btn-xs btn_width" data-toggle="modal" data-id="<?php echo $task->id; ?>"><i class="fa fa-plus-circle"></i>  <?php echo lang('add'); ?> <?php echo lang('report'); ?></button>
                                        <?php } ?>
                                    </td>
                                </tr>
                            <?php }
            ...
            <div class="modal-body">
                <form role="form" action="task/addNewTask" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group"> 
                        ...
                        <input type="text" class="form-control" name="requested_by" id="exampleInputEmail1" value='' placeholder="">
                    </div>

                    <div class="form-group"> 
                        <label for="exampleInputEmail1"> <?php echo lang('requested_for'); ?></label>
                        <input type="text" class="form-control ckeditor" name="requested_for" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    <div class="form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form role="form" action="task/addNewTask" id="editTaskForm" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('date'); ?></label>
                        <input type="text" class="form-control" name="date" id="exampleInputEmail1" value='' placeholder="">
                    </div>
                    ...
                    <div class="form-group">
                        <label class="control-label"> <?php echo lang('to_do'); ?></label>
                        <div class="">
                            <textarea class="ckeditor form-control" id="editor" name="to_do" value="<?php
                            if (!empty($task->to_do)) {
                                echo $task->to_do;
                            }
                            ?>" rows="10"></textarea>
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1"> <?php echo lang('timeline'); ?></label>
                        <input type="text" class="form-control" name="timeline" id="exampleInputEmail1" value='' placeholder="">
                    </div>
